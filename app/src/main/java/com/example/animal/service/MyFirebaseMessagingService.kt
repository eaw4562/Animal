...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        // 다른 기기에서 서버로 보냈을 때
            ...
            val userId = remoteMessage.data["userId"] ?: "default nickname"
    ...
    private fun sendNotification(title: String?, body: String){
        ...
        val channelId = "my_channel" // 채널 아이디
        val defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION) // 소리
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setContentTitle(title) // 제목
            .setContentText(body) // 내용
            .setSmallIcon(R.drawable.check) // 아이콘
            .setAutoCancel(true)
    ...
    private fun sendMessageNotification(title: String,userId: String, body: String){
        ...
        val user: androidx.core.app.Person = androidx.core.app.Person.Builder()
            .setName(userId)
            .setIcon(IconCompat.createWithResource(this,R.drawable.check))
            .build()
